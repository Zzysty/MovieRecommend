...
class UserProfile(AbstractUser):
    ...
    # 性别, 只能为男或女, 默认为男
    gender = models.CharField(max_length=7, verbose_name='性别', choices=GENDER_CHOICES, default='男')
    # 联系地址
    ...
    # 头像 默认使用default.png
    image = models.ImageField(upload_to='http://127.0.0.1:8080/media/', max_length=100, verbose_name='头像', default='大学生男.png',
...
class Avatars(models.Model):
    ...
    url = models.FileField(verbose_name='用户头像地址', upload_to='avatars/', default='人物.png')
