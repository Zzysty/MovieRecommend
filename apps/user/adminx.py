...
class UserProfileAdmin(object):
    # 列表默认显示
    list_display = ['id', 'image', 'username', 'nick_name', 'first_name', 'last_name', 'gender', 'age', 'email', 'is_staff',
                    'is_active',
    ...
    # 直接编辑
    list_editable = ['username', 'image', 'nick_name', 'first_name', 'last_name', 'gender', 'age', 'email', 'is_staff',
                     'is_active', 'location']
